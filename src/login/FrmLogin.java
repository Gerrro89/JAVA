...
public class FrmLogin extends javax.swing.JFrame {
    ...
    String administradorUsuario="JHON", administradorContraseña="123";
    String normalUsuario="STEVEN",normalContraseña="103";
    int admcode=1, normalcode=2;
    public FrmLogin() {
        initComponents();
        txtUsuario.setText("");
    ...
    private void btLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLoginActionPerformed
        ...
        if(id!=0){
            if(profile ==1){
                JOptionPane.showMessageDialog(rootPane, "Hola ADMININISTRADOR");
            }else{
                JOptionPane.showMessageDialog(rootPane, "Hola EMPLEADO A TRABAJAR");
            }
            
        }else{
            JOptionPane.showMessageDialog(rootPane, "Error", "Prueba", JOptionPane.ERROR_MESSAGE);
        }
